package android.zero.studio.shell.fastboot.data.repository
...
import android.zero.studio.shell.fastboot.domain.model.FastbootConnection
...
import android.zero.studio.fastboot.FastbootCommand
import android.zero.studio.fastboot.FastbootDeviceContext
import android.zero.studio.fastboot.FastbootException
...
class FastbootRepositoryImpl(private val context: Context) : FastbootRepository {
    ...
    private val permissionAction = "android.zero.studio.FASTBOOT_USB_PERMISSION"

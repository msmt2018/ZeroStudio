package android.zero.studio.core.data.remote.repository

import android.util.Log
import android.zero.studio.core.data.local.database.GithubRepoStatsDao
import android.zero.studio.core.data.local.mapper.toDomain
import android.zero.studio.core.data.local.mapper.toEntity
import android.zero.studio.core.data.remote.api.GithubApi
import android.zero.studio.core.data.remote.mapper.mapToRepoStats
import android.zero.studio.core.data.remote.mapper.toDomain

...
package android.zero.studio.shell.fastboot.presentation.screens
...
import android.zero.studio.core.presentation.components.navigation.FloatingNavPill
import android.zero.studio.core.presentation.components.navigation.FloatingNavPillDefaults
import android.zero.studio.core.presentation.components.navigation.FloatingNavPillItem
import android.zero.studio.core.presentation.components.text.AutoResizeableText
import android.zero.studio.core.presentation.theme.Dimens
import android.zero.studio.shell.fastboot.domain.model.FastbootState
import android.zero.studio.shell.fastboot.presentation.components.bottomsheet.FlashPartitionBottomSheet
import android.zero.studio.shell.fastboot.presentation.components.bottomsheet.GetVariablesBottomSheet
import android.zero.studio.shell.fastboot.presentation.components.bottomsheet.WipeDataBottomSheet
import android.zero.studio.shell.fastboot.presentation.components.dialog.FastbootDeviceWaitingDialog
import android.zero.studio.shell.fastboot.presentation.components.dialog.FastbootRebootOptionsDialog
import android.zero.studio.shell.fastboot.presentation.components.section.ActiveSlotsCard
import android.zero.studio.shell.fastboot.presentation.components.section.ConnectedDeviceCard
import android.zero.studio.shell.fastboot.presentation.components.section.FastbootQuickToolsCard
import android.zero.studio.shell.fastboot.presentation.components.section.UnlockStatusCard

package android.zero.studio.shell.file_browser.presentation.viewmodel
...
import android.zero.studio.shell.file_browser.data.executor.OtgCommandExecutor
import android.zero.studio.shell.file_browser.data.repository.FileBrowserRepositoryImpl
import android.zero.studio.shell.file_browser.domain.model.ConflictResolution
import android.zero.studio.shell.file_browser.domain.model.ConnectionMode
import android.zero.studio.shell.file_browser.domain.model.FileConflict
import android.zero.studio.shell.file_browser.domain.model.FileOperation
import android.zero.studio.shell.file_browser.domain.model.FileOperationResult
import android.zero.studio.shell.file_browser.domain.model.OperationStatus
import android.zero.studio.shell.file_browser.domain.model.OperationType
import android.zero.studio.shell.file_browser.domain.model.PendingPasteItem
import android.zero.studio.shell.file_browser.domain.model.PendingPasteOperation
import android.zero.studio.shell.file_browser.domain.model.RemoteFile
import android.zero.studio.shell.file_browser.domain.repository.FileBrowserRepository
import android.zero.studio.R
import android.zero.studio.shell.file_browser.presentation.model.FileBrowserEvent
import android.zero.studio.shell.file_browser.presentation.model.FileBrowserState

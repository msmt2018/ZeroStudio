...
package android.zero.studio.settings.presentation.page.licenses.screens
...
import android.zero.studio.settings.domain.model.LicensesUiState
import android.zero.studio.settings.presentation.components.dialog.AppLicenseDetailDialog
import android.zero.studio.settings.presentation.components.dialog.LicenseDetailDialog
import android.zero.studio.settings.presentation.components.scaffold.SettingsScaffold
import android.zero.studio.settings.presentation.page.licenses.components.AppLicenseCard
import android.zero.studio.settings.presentation.page.licenses.components.LibraryListItem
import android.zero.studio.settings.presentation.page.licenses.viewmodel.LicensesViewModel

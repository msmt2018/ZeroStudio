package android.zero.studio.shell.wifi_adb_shell.notification
...
import android.zero.studio.activities.MainActivity
...
class AdbConnectionNotificationHelper(private val context: Context) {
    ...
    companion object {
        ...
        const val ACTION_DISCONNECT = "android.zero.studio.ACTION_DISCONNECT"
    }

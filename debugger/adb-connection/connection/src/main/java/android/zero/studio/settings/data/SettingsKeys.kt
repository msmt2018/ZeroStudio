package android.zero.studio.settings.data
...
sealed class SettingsKeys<out T>(
    ...
    data object PaletteStyle : SettingsKeys<Int>(
        "PALETTE_STYLE",
        android.zero.studio.core.domain.model.PaletteStyle.TONAL_SPOT.ordinal
    )

    data object GithubReleaseType :
        SettingsKeys<Int>(
            "GITHUB_RELEASE_TYPE",
            android.zero.studio.core.domain.model.GithubReleaseType.STABLE_GITHUB
        )
    ...
    data object LocalAdbWorkingMode :
        SettingsKeys<Int>(
            ...
            android.zero.studio.core.domain.model.LocalAdbWorkingMode.BASIC
        )

    data object TerminalFontStyle :
        SettingsKeys<Int>(
            "TERMINAL_FONT_STYLE",
            android.zero.studio.core.domain.model.TerminalFontStyle.MONOSPACE
        )

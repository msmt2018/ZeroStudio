package android.zero.studio.shell.otg_adb_shell.data.repository
...
import android.zero.studio.adblib.UsbChannel
...
class OtgRepositoryImpl(private val context: Context) : OtgRepository {
    ...
    private val permissionAction = "android.zero.studio.USB_PERMISSION"

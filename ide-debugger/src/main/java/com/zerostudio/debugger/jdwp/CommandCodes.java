 ...
 *
 *  Each nested class holds the command codes for one JDWP command set
 *  (VirtualMachine, ReferenceType, etc.). They are nested inside
 *  {@link CommandCodes} so callers can keep using
 *  {@code CommandCodes.EventRequestCmd.Set} etc.
 */
...
public final class CommandCodes {
    ...
    public static final class VirtualMachineCmd {
    ...
    public static final class ReferenceTypeCmd {
    ...
    public static final class ClassTypeCmd {
     ...
     */
    public static final class ArrayReferenceCmd {
    ...
    public static final class EventRequestCmd {
    ...
    public static final class StackFrameCmd {
    ...
    public static final class ThreadReferenceCmd {
    ...
    public static final class ObjectReferenceCmd {
     ...
     * Currently only {@link StringReferenceCmd.Value} is used (to read
     * an exception message).
     */
    public static final class StringReferenceCmd {
    ...
    public static final class MethodCmd {

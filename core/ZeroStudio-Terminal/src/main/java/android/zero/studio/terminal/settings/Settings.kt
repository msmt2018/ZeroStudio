package android.zero.studio.termux.settings
...
import android.zero.studio.termux.ui.screens.settings.InputMode
...
object Settings {
   ...
   var default_night_mode
    ...
    private val DEFAULT_NUMBER_SHORTCUT = android.zero.studio.termux.ui.screens.terminal.ShortcutBinding(alt = true, keyCode = android.view.KeyEvent.KEYCODE_1)

    fun getNumberShortcutBinding(): android.zero.studio.termux.ui.screens.terminal.ShortcutBinding {
        val raw = Preference.getString(key = "number_shortcut_modifier", default = DEFAULT_NUMBER_SHORTCUT.serialize())
        return android.zero.studio.termux.ui.screens.terminal.ShortcutBinding.deserialize(raw)
    }

    fun setNumberShortcutBinding(binding: android.zero.studio.termux.ui.screens.terminal.ShortcutBinding) {
    ...
    fun getShortcutBinding(action: android.zero.studio.termux.ui.screens.terminal.ShortcutAction): android.zero.studio.termux.ui.screens.terminal.ShortcutBinding {
        val raw = Preference.getString(key = action.prefKey, default = action.default.serialize())
        return android.zero.studio.termux.ui.screens.terminal.ShortcutBinding.deserialize(raw)
    }

    fun setShortcutBinding(action: android.zero.studio.termux.ui.screens.terminal.ShortcutAction, binding: android.zero.studio.termux.ui.screens.terminal.ShortcutBinding) {

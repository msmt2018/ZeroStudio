...
class SessionService : Service() {
    ...
    var currentSession = mutableStateOf(Pair("main",android.zero.studio.termux.settings.Settings.working_Mode))
    ...
    fun setCustomName(sessionId: String, name: String) {
        if (name.isBlank()) {
            ...
            android.zero.studio.termux.settings.Settings.setCustomSessionName(sessionId, name)
        }
    }
    ...
    inner class SessionBinder : Binder() {
        ...
        fun createSession(id: String, client: TerminalSessionClient, activity: MainActivity,workingMode:Int): TerminalSession {
            return MkSession.createSession(activity, client, id, workingMode = workingMode).also {
                ...
                android.zero.studio.termux.settings.Settings.getCustomSessionName(id)?.let { name ->

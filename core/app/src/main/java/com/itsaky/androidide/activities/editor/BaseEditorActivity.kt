    ...
    bubble.setOnBubbleClickListener {
      ...
      if (isHeaderContainerExpanded) {
          ...
          header.animate()
              ...
              .translationY(header.height * 0.5f) // 向下平移一半高度
              .alpha(0f)
              .setDuration(250)
